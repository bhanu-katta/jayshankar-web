          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-4xl md:text-6xl font-bold leading-tight">
                Building Tomorrow's
                <span className="text-gold-400 block">Business Empire</span>
              </h1>
              <p className="text-xl text-gray-300 leading-relaxed">
                A diversified conglomerate driving innovation across multiple industries, 
              ...
              <div className="bg-white rounded-xl p-6 text-navy-900">
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-center">
                    <div>
                      <div className="text-2xl font-bold">₹25,000Cr</div>
